...
public class Triangle extends Shape{
    ...
    public double area() {
        ...
        s = (getSide1Length()+getSide2Length()+getSide3Length())/2;
        area = s*((s - getSide1Length())*(s - getSide2Length())*(s - getSide3Length()));
        return Math.sqrt(area);
    }

    @Override
    public double perimeter() {
        return getSide3Length()+getSide2Length()+getSide1Length();
    }
